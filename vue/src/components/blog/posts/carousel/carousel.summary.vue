<template lang="html">
    <div class="">
        <div class="well col-xs-12 col-sm-10 col-sm-offset-1">
            <h3>Round &amp; Round</h3>
            <img src="/static/images/ratt.png" alt="code" class="img-responsive col-xs-12 col-sm-8"/>
            ...
            <h3 class="pull-right"><router-link :to="{ path: '/blog/posts/carousel' }">Read More  &gt;&gt;</router-link></h3>
        </div>
    </div>
</template>
